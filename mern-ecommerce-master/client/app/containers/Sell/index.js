...
class Sell extends React.PureComponent {
  render() {
    ...
    return (
      <div className='sell'>
        <h2>Become A Fashion-Bazar Store Seller!</h2>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Would you like to sell your products on Fashion-Bazar Store!</h3>
                  <h4>Grow your business with Fashion-Bazar Store</h4>
                  <b>Apply Today</b>
                </div>
              </Col>
